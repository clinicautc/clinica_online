...
(async () => {
  ...
  await page.screenshot({ path: __dirname + '/screenshots/final-03b-hub-check.png' });
  ...
  await page.screenshot({ path: __dirname + '/screenshots/final-03b-seguimiento-captura.png', fullPage: true });
  console.log('Seguimiento captura — screenshot tomado');
