...
(async () => {
  ...
  const el = await page.locator('text=Antecedentes personales no pato').first().locator('xpath=ancestor::section[1]');
  await el.screenshot({ path: __dirname + '/screenshots/nopato_before.png' });
