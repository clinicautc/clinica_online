...
(async () => {
  ...
  await page.screenshot({ path: __dirname + '/screenshots/final-02b-fisioterapia-captura.png', fullPage: true });
  console.log('Fisioterapia captura — screenshot tomado');

  // Reverificar botón Guardar corregido en modo solo lectura
  ...
  console.log('Botón Guardar/Guardado en solo lectura fisioterapia (debe ser 0 tras la corrección):', btnCount);
  await page.screenshot({ path: __dirname + '/screenshots/final-05b-fisioterapia-readonly-fixed.png', fullPage: true });
