...
router.post('/notas_universitarias', requireAuth, notasController.createUniversitaria);
router.put('/notas_universitarias/:id/responder', requireAuth, notasController.responderUniversitaria);
