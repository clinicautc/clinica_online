 ...
 * PROPÓSITO: Panel principal del paciente con mapeo de datos real de la DB.
 * ============================================================================
 */
...
export default function PatientDashboard() {
  ...
  /**
   * NOTA SHERLOCK: Mapeo de datos para compatibilidad con SQL.
   * Extraemos los campos exactos que vienen de tu tabla 'usuarios'.
   */
      ...
      <header className="bg-white border-b border-blue-900/10 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
            ...
            {/* Info Usuario y Logout - SINCRONIZADO CON DB */}
            <div className="flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto border-t sm:border-t-0 pt-2 sm:pt-0">
              <div className="text-left sm:text-right">
                <p className="text-sm font-semibold text-blue-900 leading-none mb-1">
                  {patientName}
                </p>
                <p className="text-[10px] sm:text-xs text-blue-900/60 uppercase tracking-wider">
                  {patientRole}
                </p>
              </div>
              <Button
            ...
            <TabsContent value="appointments" className="animate-in fade-in-50 duration-300">
              <div className="bg-white rounded-xl shadow-sm border border-blue-900/5 overflow-hidden">
                {/* MODIFICACIÓN DE SEGURIDAD: 
                  Pasamos el patientId real capturado de la base de datos.
                */}
