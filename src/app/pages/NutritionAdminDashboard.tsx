...
// CORRECCIÓN: Se eliminó la importación de 'MedicalHistoryViewer' que no se usaba en este archivo
...
export default function NutritionAdminDashboard() {
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const filtered = allAppointments.filter((apt) => {
            ...
            return cleanAptDate === todayStr && apt.tipo === 'nutricion';
          });
    ...
    // CORRECCIÓN: Manejo de promesas con void para evitar el error de linter
                              ...
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  ...
                                  <div className="flex gap-3 items-center mt-1">
                                    ...
                                    {/* CORRECCIÓN: Se usó el componente Badge para quitar el error de linter */}
                                    <Badge variant="outline" className="text-[10px] bg-green-50 text-green-700 font-black border-green-100 uppercase">{apt.estado}</Badge>
                                  </div>
                                </div>
                              </div>
