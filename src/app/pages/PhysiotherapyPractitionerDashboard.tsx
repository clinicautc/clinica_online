...
export default function NutritionPractitionerDashboard() {
  ...
  /**
   * CORRECCIÓN: Redirección sincronizada con App.tsx y routes.tsx
   * Se ajusta la ruta a '/forms/nutricion/' para que el Router lo reconozca.
   */
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-orange-900/60 font-serif italic">Practicante: {user?.nombre || "Usuario UTC"}</p>
              </div>
            </div>
